...
4. [info] Update version information and tool name (Relay -> Edge).
5. [info] Update info tool to work better with non-LmP releases.
6. [info] CPU-frequency printing is evenly spaced and handles non-existent cpu-frequencies.
7. [info] Process state reporting takes better into account non-running processes.
8. [info] Clean shellcheck findings.
